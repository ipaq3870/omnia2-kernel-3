...
#if 0
static struct gpio_keys_button s3c_gpio_keys_data[] = {
	{
		.gpio = GPIO_POWER_N,
		.code = 249,
		.desc = "Power",
...
static struct gpio_keys_platform_data s3c_gpio_keys_pdata = {
	.buttons = s3c_gpio_keys_data,
	.nbuttons = ARRAY_SIZE(s3c_gpio_keys_data),
};

static struct platform_device s3c_gpio_keys = {
	.name = "gpio-keys",
	.id = 0,
	.num_resources = 0,
	.dev = {
		.platform_data = &s3c_gpio_keys_pdata,
	}
};
#endif
